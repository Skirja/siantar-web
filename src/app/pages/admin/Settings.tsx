...
import { ArrowLeft, CreditCard, DollarSign, Save, Loader2, Plus, Trash2, Edit2, X } from "lucide-react";
...
export function Settings() {
  ...
  const { paymentAccounts, refreshPaymentAccounts, feeSettings, refreshFeeSettings } = useData();
